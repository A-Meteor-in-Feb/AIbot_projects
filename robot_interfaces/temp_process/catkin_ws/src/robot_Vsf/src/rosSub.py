...
class RosSub:
    def __init__(self, state: dataInfo.StateInfo):
        ...
        self.topic_position = "/global_localization" #这个之后需要换成jianyu的发布的数据话题
        ...
        #话题订阅
        self.sub_position = rospy.Subscriber(self.topic_position, Odometry, self.callback_position, queue_size=1, tcp_nodelay=True)
    ...
    def callback_position(self, msg: Odometry):
        ...
        self.state.update_position(msg.pose.pose.position.x, msg.pose.pose.position.y, yaw)
