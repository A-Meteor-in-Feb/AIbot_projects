...
class Goal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('binId')) {
        this.binId = initObj.binId
      }
      else {
        this.binId = 0;
      }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [binId]
    bufferOffset = _serializer.uint32(obj.binId, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [binId]
    data.binId = _deserializer.uint32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.binId !== undefined) {
      resolved.binId = msg.binId;
    }
    else {
      resolved.binId = 0
    }
