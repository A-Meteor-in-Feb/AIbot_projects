...
;//! \htmlinclude Sub.msg.html

(cl:defclass <Sub> (roslisp-msg-protocol:ros-message)
  ((x
    :reader x
    :initarg :x
    :type cl:float
...
(cl:defmethod cl:initialize-instance :after ((m <Sub>) cl:&rest args)
  (cl:declare (cl:ignorable args))
  (cl:unless (cl:typep m 'Sub)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name robot-msg:<Sub> is deprecated: use robot-msg:Sub instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <Sub>))
...
(cl:defmethod heading-val ((m <Sub>))
...
(cl:defmethod floor_id-val ((m <Sub>))
...
(cl:defmethod user_id-val ((m <Sub>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader robot-msg:user_id-val is deprecated.  Use robot-msg:user_id instead.")
  (user_id m))
(cl:defmethod roslisp-msg-protocol:serialize ((msg <Sub>) ostream)
  "Serializes a message object of type '<Sub>"
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <Sub>) istream)
  "Deserializes a message object of type '<Sub>"
    (cl:let ((bits 0))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Sub>)))
  "Returns string type for a message object of type '<Sub>"
  "robot/Sub")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Sub)))
  "Returns string type for a message object of type 'Sub"
  "robot/Sub")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql '<Sub>)))
  "Returns md5sum for a message object of type '<Sub>"
  "8c3fed3fa27ab9dbf5a4834ff70d5a2e")
(cl:defmethod roslisp-msg-protocol:md5sum ((type (cl:eql 'Sub)))
  "Returns md5sum for a message object of type 'Sub"
  "8c3fed3fa27ab9dbf5a4834ff70d5a2e")
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<Sub>)))
  "Returns full string definition for message of type '<Sub>"
  (cl:format cl:nil "float64 x~%float64 y~%float64 heading~%string floor_id~%string user_id~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'Sub)))
  "Returns full string definition for message of type 'Sub"
  (cl:format cl:nil "float64 x~%float64 y~%float64 heading~%string floor_id~%string user_id~%~%"))
(cl:defmethod roslisp-msg-protocol:serialization-length ((msg <Sub>))
  (cl:+ 0
     8
     8
     8
...
(cl:defmethod roslisp-msg-protocol:ros-message-to-list ((msg <Sub>))
